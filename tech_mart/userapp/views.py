...
def my_wallet(request):
    ...
    print("***********************************")
    print(wallet_orders)
    context = {'wallet_amount': wallet_amount, 'wallet_orders': wallet_orders}
    ...
    if wallet.amount>order.order_total:
        ...
        for cart_item in cart_items:
            ...
            order_product = OrderProduct(
                ...
                product_price=cart_item.product.price_after_discount,
                ordered=True,
            )
            order_product.save()
...
def order_invoice(request, order_id):
    ...
    try:
        ...
        for order_item in order_items:
            order_item_total = order_item.product.price_after_discount * order_item.quantity
